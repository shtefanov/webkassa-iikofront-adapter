...
function normalizeCheckResponse(response) {
  ...
  return {
    ...
    checkNumber: String(required(data.CheckNumber, 'CheckNumber')),
    dateTime: required(data.DateTime, 'DateTime'),
    ...
    checkOrderNumber: numberOrNull(data.CheckOrderNumber),
...
function normalizeHistoryRow(row) {
  try {
    ...
    return {
      ...
      checkNumber: row && row.CheckNumber ? String(row.CheckNumber) : null,
      dateTime: row && row.DateTime ? row.DateTime : null,
      dateTimeUTC: row && row.DateTimeUTC ? row.DateTimeUTC : null,
      ...
      cashboxRegistrationNumber: row && (row.CashboxRegistrationNumber || row.RegistrationNumber || cashbox.RegistrationNumber)
        ...
        : null,
      checkOrderNumber: numberOrNull(row && row.CheckOrderNumber),
